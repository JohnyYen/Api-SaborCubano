...
using SaborCubano.Infrastructure.Persistence.Interceptor;
...
public class ApplicationDBContext : IdentityDbContext<User>
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder
        .UseNpgsql("HOST=Localhost;USERNAME=postgres;Database=SaborCubano;PORT=5432;PASSWORD=0403")
        .AddInterceptors(new ManyToManyIncludeInterceptor());
    }
