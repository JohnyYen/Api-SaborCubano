...
namespace SaborCubano.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250119171744_Rest_Config")]
    partial class Rest_Config
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivityAppUser", b =>
                {
                    ...
                    b.HasKey("ActivitiesId", "AppUserId");
            ...
            modelBuilder.Entity("AppUserCoupon", b =>
                {
            ...
            modelBuilder.Entity("IngredientPlate", b =>
                {
                    ...
                    b.HasKey("IngredientsId", "PlatesId");

                    b.HasIndex("PlatesId");

                    b.ToTable("IngredientPlate");
                });
            ...
            modelBuilder.Entity("SaborCubano.Domain.Models.Coordinates", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AppUserCoupon", b =>
                {
                    ...
                    b.HasOne("api.Models.Coupon", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.Models.Restaurant", b =>
                {
                    ...
                    b.HasOne("SaborCubano.Domain.Models.Coordinates", "Coordinates")
                        .WithOne("Restaurant")
                        .HasForeignKey("api.Models.Restaurant", "Id_Coord");
